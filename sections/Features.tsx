      ...
      <div className="container sm:max-w-2xl md:max-w-6xl lg:max-w-full">
        ...
        <div className="mt-12 grid grid-cols-1 md:grid-cols-4 lg:grid-cols-3 gap-8">
              ...
              <Avatar className="-ml-6 border-transparent group-hover:border-green-500 transition">
                <div className="size-full bg-neutral-700 rounded-full inline-flex items-center justify-center gap-1 relative">
                  ...
                  {Array.from({ length: 3 }).map((_, i) => (
                    <span
                      key={i}
                      className="size-1.5 rounded-full bg-white inline"
                    ></span>
                  ))}
                </div>
              </Avatar>
          ...
          >
            <div className="aspect-video flex items-center justify-center gap-4">
              ...
              <Key className="outline-transparent group-hover:outline-lime-400 outline-2 outline-offset-4 transition-all duration-500 group-hover:translate-y-1 delay-300">
                C
              </Key>
            </div>
          </FeatureCard>
        ...
        <div className="mt-8 flex flex-wrap gap-3 justify-center">
          {features.map((feature) => (
            ...
            >
              <span className="bg-lime-400 text-neutral-950 size-5 rounded-full inline-flex items-center justify-center text-xl group-hover:rotate-360 transition duration-300">
                &#10038;
              </span>
